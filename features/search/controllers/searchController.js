...
const { Service: Marketplace } = require('../../marketplace/models/Marketplace');
const { Product: Supplies } = require('../../supplies');
const { Course } = require('../../academy/models/Academy');
const { RentalItem } = require('../../rentals/models/Rentals');
...
const searchServices = async (query, filters = {}) => {
  try {
    ...
    if (filters.location) {
      ...
      const { buildServiceAreaQuery } = require('../../../src/utils/serviceAreaHelper');
